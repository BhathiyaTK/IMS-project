...
+function ($) {
	...
	var months = ['January','February','March','April','May','June','July','August','September','October','November','December'],
		short_months = ['January','February','March','April','May','June','July','Augest','September','October','November','December'],
		daysofweek = ['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'],
		short_days = ['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'],
	...
	DCalendar.prototype = {
		...
		reformatDate : function (date, dateFormat) {
			var that = this,
				format = typeof dateFormat === 'default' ? that.options.format : dateFormat,
				...
				firstD = format.indexOf('d'), firstM = format.indexOf('m'), firstY = format.indexOf('y'),
				 day = '', month = '', year = '';
			...
			return { d: day, m: month, y: year, date: isNaN(parseInt(month)) ? new Date( day + " " + month + ", " + year) : new Date(year, month - 1, day) };
		},
		...
		create : function(){
			var that = this,
				...
				cardhead = $('<section class="calendar-head-card"><span class="calendar-date-wrapper" title="Select current date."><span class="calendar-dayofweek"></span> | <span class="calendar-month"></span> <span class="calendar-date"></span>,</span> <span class="calendar-year"></span></section>'),
